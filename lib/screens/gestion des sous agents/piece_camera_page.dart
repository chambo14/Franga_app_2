...
class PieceCameraPage extends StatefulWidget {
  const PieceCameraPage({super.key, required this.camera});
  final List<CameraDescription>? camera;

  @override
  State<PieceCameraPage> createState() => _PieceCameraPageState();
}

class _PieceCameraPageState extends State<PieceCameraPage> {
                    ...
                    Expanded(
                        child: IconButton(
                          ...
                          onPressed: () {
                            ...
                            initCamera(widget.camera![_isRearCameraSelected ? 0 : 1]);
                          },
                        )),
                    const Spacer(),
                  ]),
